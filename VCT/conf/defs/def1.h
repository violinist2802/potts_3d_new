...
#define sizeX (0.125*MULT)		// [mm]
#define sizeY (0.125*MULT)		// [mm]
#define sizeZ (0.125*MULT)		// [mm]
#define sizeMarginX 0.0125		// [mm] from one side
#define sizeMarginY 0.0125		// [mm] from one side
#define sizeMarginZ 0.0125		// [mm] from one side
#define MARGINX rounder(sizeMarginX/VOXSIZE)
#define MARGINY rounder(sizeMarginY/VOXSIZE)
#define MARGINZ rounder(sizeMarginZ/VOXSIZE)
#define NVX rounder((sizeX+2*sizeMarginX)/VOXSIZE) 
#define NVY rounder((sizeY+2*sizeMarginY)/VOXSIZE) 
#define NVZ rounder((sizeZ+2*sizeMarginZ)/VOXSIZE) 
